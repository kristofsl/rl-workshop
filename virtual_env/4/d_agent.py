...
class DeepQAgent:
    ...
    def __init__(self, env, gamma, memory_size, exploration_decay, layer_size, batch_size, exploration_min, learning_rate, update_model_steps = 20, extra_intermediate_layers = 0, exploration_rate = 1.0):
        self.__env = env
        self.__gamma = gamma
        self.__state_size = 8                                           # we have an 8 numbers that represent our size and this will be the input for our neural net
        self.__action_size = 4                                          # we have 4 possible actions (push the card to the left or to the right)
